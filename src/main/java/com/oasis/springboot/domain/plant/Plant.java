...
public class Plant extends BaseTimeEntity {
    ...
    @Builder
    public Plant(String name, LocalDateTime adoptingDate, Integer waterInterval, Integer nutritionInterval, Integer repottingInterval, Double sunshine, Double waterSupply, Integer highTemperature, Integer lowTemperature, User user) {
        this.name = name;
